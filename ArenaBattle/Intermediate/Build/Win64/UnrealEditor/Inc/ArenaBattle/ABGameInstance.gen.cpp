...
template<> ARENABATTLE_API UScriptStruct* StaticStruct<FABCharacterData>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_ABGameInstance_h_Statics::ScriptStructInfo[] = {
		{ FABCharacterData::StaticStruct, Z_Construct_UScriptStruct_FABCharacterData_Statics::NewStructOps, TEXT("ABCharacterData"), &Z_Registration_Info_UScriptStruct_ABCharacterData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FABCharacterData), 2864986732U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_ABGameInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UABGameInstance, UABGameInstance::StaticClass, TEXT("UABGameInstance"), &Z_Registration_Info_UClass_UABGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UABGameInstance), 2081283738U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_ABGameInstance_h_1600431341(TEXT("/Script/ArenaBattle"),
