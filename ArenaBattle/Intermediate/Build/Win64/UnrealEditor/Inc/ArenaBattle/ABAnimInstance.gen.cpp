...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UABAnimInstance_Statics::NewProp_CurrentPawnSpeed_MetaData[] = {
		...
		{ "Category", "Pawn" },
		{ "Comment", "// ????????\xc6\xae???? ?????\xcf\xb4? \xc5\xb0???? == BlueprintReadOnly, BlueprintReadWrite\n" },
		{ "ModuleRelativePath", "Public/ABAnimInstance.h" },
		{ "ToolTip", "????????\xc6\xae???? ?????\xcf\xb4? \xc5\xb0???? == BlueprintReadOnly, BlueprintReadWrite" },
	};
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_ABAnimInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UABAnimInstance, UABAnimInstance::StaticClass, TEXT("UABAnimInstance"), &Z_Registration_Info_UClass_UABAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UABAnimInstance), 1141908937U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_ABAnimInstance_h_1623812891(TEXT("/Script/ArenaBattle"),
